...
## Table of Contents
- [1.6.0 - 25-05-2025](#160---25-05-2025)
- [1.5.0 - 21-04-2025](#150---21-04-2025)
...
### Changed
- Moved from Vercel to Cloudflare
...
### Changed
- Re-did the whole UI for the `blog-detail` page.
...
### Changed
- Final Year Project submitted; working on the project description (on this website)
